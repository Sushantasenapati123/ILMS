...
{
    public class SendSMSRepository : i3msRepositoryBase, ISendSMSRepository
    {
        private readonly ILogger<SendSMSRepository> Logger;
        public SendSMSRepository(Ii3msConnectionFactory connectionFactory, ILogger<SendSMSRepository> logger) : base(connectionFactory)
        {
            Logger = logger;
