...
namespace Ilms.Repository.BaseRepository
{
    public class i3msRepositoryBase : Ii3msRepositoryBase
    {
        /// <summary>
        /// Gets the connection.
        /// </summary>
        ...
        protected i3msRepositoryBase(Ii3msConnectionFactory connectionFactory)
        {
            try
            {
