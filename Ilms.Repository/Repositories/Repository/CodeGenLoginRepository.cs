...
{
    public class CodeGenLoginRepository : i3msRepositoryBase, ICodeGenLoginRepository
    {
        public CodeGenLoginRepository(Ii3msConnectionFactory TConnectionFactory) : base(TConnectionFactory)
        {
